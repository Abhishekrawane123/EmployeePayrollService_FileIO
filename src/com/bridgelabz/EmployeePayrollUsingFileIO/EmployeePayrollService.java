package com.bridgelabz.EmployeePayrollUsingFileIO;
...
* */
    public static void main(String args[]) {
        EmployeePayrollService service = new EmployeePayrollService();          //Creating object of class to access methods in class
